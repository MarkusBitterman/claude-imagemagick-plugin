...
- [ ] Submit to the official directory: https://clau.de/plugin-directory-submission (license ✓, tagged release ✓ — `imagemagick--v0.7.0`, GitHub release published; still needs: pick a category + fill the form)
